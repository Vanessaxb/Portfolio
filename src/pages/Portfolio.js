    ...
    <div className="flex-col ">
      ...
      <div className=" items-center p-20 mt-4 md:mt-20 ">
        <div className="flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="md:w-1/2 mt-4 md:-mt-16 mt">
            <h1 className=" text-2xl md:text-4xl text-green-500 font-raleway mb-3 md:mb-5 text-center ">
              Memory Game
            </h1>
            <p className="font-raleway text-base md:text-lg text-center mb-1 md:mb-1">
            ...
            <div className="flex justify-center p-4 mr:8 md:mr-16 ">
              <a
