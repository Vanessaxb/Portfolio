  ...
  return (
    <div className="p-4 md:p-20 flex flex-col items-center justify-center min-h-screen">
      <div className="fixed left-0 top-1/2 transform -translate-y-1/2 ">
        ...
        <br />
        <a
          href="https://www.linkedin.com/in/vanessa-beattie/"
          target="_blank"
          rel="noreferrer"
        >
          <FaLinkedin size={40} />
      ...
      <div className="pHome mt-6 md:mt-12">
        <p className="font-raleway text-lg md:text-3xl text-center md:text-center">
          Hi, I'm a Software Engineer. <br />
          My love for tech, people and travelling is what moves me.
        </p>
      </div>
      <div className="buttonHome text-center md:text-left p-4">
        <Link className="font-raleway hover:text-red-500 " to="/Portfolio">
          View my work
        </Link>
      </div>
      <section>
        <div className="relative">
          ...
          <div className="flex flex-col items-center mt-36 font-raleway">
            ...
            <div className="bg-gray-600/20 p-4 shadow-md rounded-md mt-4 backdrop-blur z-10">
              <h2 className="mt-4 text-3xl md:text-6xl mb-4 z-20 text-red-500">
                Vanessa Beattie
              </h2>
              <p className="font-raleway text-base md:text-lg text-center p-2 md:p-4 z-20 text-white">
                Proficient across a spectrum of technologies, including{" "}
                <span className="text-green-400">
                  HTML, CSS, Tailwind, JavaScript, MVC Framework, React/Redux,
                  Express JS, Node JS, MERN, SQL, PostgreSQL Restful Routes-API,
                  Express Mongoose and MongoDB
                </span>
                , I'm committed to delivering innovative solutions that meets
                the user needs with cuttting-edge technology. My journey in the
                tech industry is complemented by my academic accomplishments:{" "}
                <span className="text-green-400">
                  a degree in Electronics Engineering and an MBA
                </span>
                .
                <br />
                <br />
                With professional experience spanning Telecom, Humanitarian Aid,
                and Finances, I bring a diverse background to the world of
                software engineering. Fluent in three languages—{" "}
                <span className="text-green-400">
                  Portuguese, Spanish, and English
                </span>
                —I've had the privilege of working across more than ten
                different countries. <br />
                In these dynamic environments, I've led transcultural teams and
                managed multi-million-dollar project budgets, honing my
